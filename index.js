...
(function () {
     ...
     * @type {Array<number>}
     */
    DistanceMeter.yPos = [0, 27, 40, 53, 67, 80, 93, 107, 120];
    ...
    Cloud.prototype = {
        ...
        update: function (speed) {
            if (!this.remove) {
                // udate below to change the cloud speed (i dont think you can go too low)
                this.xPos -= 0.07;
                this.draw();
